...
\author[1,2,3]{Mauro Silberberg\ORCID{0000-0002-2402-1100}}
\author[3]{Henning Hermjakob\ORCID{0000-0001-8479-0262}}
\author[3,4]{Rahuman S. Malik-Sheriff\ORCID{0000-0003-0705-9809}}
\author[1,2,$\ast$]{Hernán E. Grecco\ORCID{0000-0002-1165-4320}}

\authormark{Author Name et al.}

\address[1]{
  \orgname{Universidad de Buenos Aires, Facultad de Ciencias Exactas y Naturales, Departamento de Física},
  \orgaddress{\state{Buenos Aires}, \country{Argentina}}
}
\address[2]{
  \orgname{CONICET - Universidad de Buenos Aires, Instituto de Física de Buenos Aires (IFIBA)},
  \orgaddress{\state{Buenos Aires}, \country{Argentina}}
}
\address[3]{
  \orgdiv{European Bioinformatics Institute},
  \orgname{European Molecular Biology Laboratory (EMBL-EBI)},
  \orgaddress{\street{Wellcome Genome Campus}, \state{Cambridge}, \country{UK}}
}
\address[4]{
  Secondary Affiliation:
  \orgdiv{Department of Surgery and Cancer, Faculty of Medicine},
  \orgname{Imperial College London},
  \orgaddress{\state{London}, \country{UK}}
}
...
\\ \textbf{Availability:}
  Poincaré and SimBio are released under the MIT license.
  their source code is available on GitHub
  (\url{https://github.com/maurosilber/poincare}
  and \url{https://github.com/hgrecco/simbio}).
  and can be installed from PyPI or conda-forge.
\\ \textbf{Contact:} \href{email:hgrecco@df.uba.ar}{hgrecco@df.uba.ar}
}
