...
Excluding models that use not yet supported \ac{SBML} feature,
every simulation returned correct results within the solver tolerances.

To evaluate SimBio's performance,
we used curated \ac{SBML} models from BioModels \cite{malik-sheriffBioModels15Years2020}.
Among the first 250 curated models,
...
Within SimBio, both NumPy and Numba
...
We measured three simulation stages:
