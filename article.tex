...
\caption{First-order system of an exponential decay. The variable
...
\caption{Second-order system of an harmonic oscillator, where the
...
\caption{First-order system of two exponential decays by composition of
