---
title: "SimBio: a versatile and expandable Python package for modeling systems."
...
and an extension for Visual Studio Code has been created [@vscode-antimony].
...
We developed SimBio,
an open-source Python package for defining and simulating reaction networks,
to address these two issues.
It focuses on providing an ergonomic experience for end-users
...
since it is coded in pure Python,
which is beneficial for power users.
TODO: high degree of flexibility,  large potential to leverage existing python tools.  For example, ....
...
TODO: NOT SURE SUBSECTIONS ARE A GOOD IDEA. MAYBE JUST BOLD
