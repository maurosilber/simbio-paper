...
import numpy as np
import seaborn
from poincare import Derivative, Variable, System, initial
from poincare import Simulator


def plot(model, figheight):
    ax = (
        Simulator(model)
        .solve(save_at=np.linspace(0, 5, 101))
        .plot(figsize=(2, figheight))
    )
...
:::: {#fig-code layout-nrow=3 .column-body-outset}
