...
abstract: >
    ...
    In contrast to existing Python tools for CRN modeling,
    that wrap external C/C++ libraries for simulation,
    ...
    In conclusion, the Python-centric approach,
    coupled with the packages' extensibiltiy,
    positions Poincaré and SimBio as valuable tools for the modeling community.
