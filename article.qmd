...
**TODO: is `RateLaw` not better term than `MassAction`?**
...
**TODO: I amnto sure whether the number of figures are already over the limit, you may have to combine figures, while doing so, if space permits create a small schematics / summary figure, with icons and texts showing the significance / and applicability of the tools developed.**
